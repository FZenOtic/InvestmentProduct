...
const isRedecideMode = ref(false); // New state to track if user is re-deciding
...
const confirmAndNextRound = () => {
    ...
    const logData = {
        ...
        decision: { type: isRedecideMode.value && decisionAI.value ? 'AI' : 'SELF' },
...
@media screen and (max-width: 768px) {
    ...
    .ai-header { font-size: clamp(1.3rem, 5vw, 1.8rem); }
    ...
    .btn-redecide, .btn-confirm { border-radius: 6px; }
